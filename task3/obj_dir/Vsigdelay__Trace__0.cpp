...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+4,(vlSelf->wr_en),8);
    bufp->chgCData(oldp+5,(vlSelf->rd_en),8);
    bufp->chgCData(oldp+6,(vlSelf->din),8);
    ...
    bufp->chgBit(oldp+10,((1U & (IData)(vlSelf->wr_en))));
    bufp->chgSData(oldp+11,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT__address) 
                                       + (IData)(vlSelf->offset)))),9);
    bufp->chgSData(oldp+12,(vlSelf->sigdelay__DOT__address),9);
    bufp->chgBit(oldp+13,((1U & (IData)(vlSelf->rd_en))));
}
